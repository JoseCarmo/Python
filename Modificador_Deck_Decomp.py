...
for linhas in LINHAS_DADGER: # corre todas as linhas do script 
    ...
    # BLOCO PARA RESTRIÇÕES (RE, HV, HQ)
    else:
...
NOVO_ARQUIVO_DADGER = open("C:\\Users\\Joseeustaquio\\Downloads\\PMO_deck_preliminar\\DEC_ONS_072018_RV0_VE\\DADGER1.RV1", "w") # um novo arquivo do DADGER.RVO passa a ser criado
